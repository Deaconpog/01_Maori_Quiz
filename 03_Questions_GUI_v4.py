"""" 03_Questions_GUI_v4.py
Begins the quiz for the user and gives them multiple choice answers
Version #4 - Code will ask a question and supply user with 4 possible answers
version 4 allows the user to input all answers and then outputs a score for the
user before stopping the quiz.
Built upon previous versions this is a very rough version that has had no
fine-tuning nor is designed aesthetically appropriate yet,
"""
