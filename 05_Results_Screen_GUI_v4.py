"""" 05_Results_Screen_GUI_v4_(Trial_2).py
Begins the quiz for the user and gives them multiple choice answers
Version #4 - Code now runs the quiz without issue and now allows for the export
button to function correctly and save actual text in the .txt file, also have
tidied up the code to make it look more aesthetically proper, and tweaked a
few things.
"""
...
class Display:
    ...
    def export(self, previous, final_result):
        ...
        self.export_text = Label(self.export_frame,
                                 ...
                                 , justify=LEFT, bg="light salmon",  # Pink
