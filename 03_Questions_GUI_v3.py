"""" 03_Questions_GUI_v3.py
Begins the quiz for the user and gives them multiple choice answers
Version #3 - Code will ask a question and supply user with 4 possible answers
version 3 allows the user to input one of the optional answers and continues
onto the next question.
Built upon #1 and #2 this is a very rough version that has had no fine-tuning
