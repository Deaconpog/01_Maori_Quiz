""" 06_Full_Quiz_v2.py
Version #2 - Version 2 has simply been redo and undergone alterations based
on the PEP8 guidelines making the code more smooth to run and looking more
clean and tidy.
"""
...
class Opening:
    ...
    def help(self):
        ...
        get_help.help_text.configure(text="Kia ora, welcome to the \n Māori "
                                          ...
                                          "given 15 multi-choice questions. "
                                          "\n\n Your score "
    ...
    def start(self):
        ...
        class Display:
            def __init__(self, r_result):
                ...
                maori_quiz.destroy()
                result_gui = Tk()
                # Result window dimensions and other details
...
class Help:
    def __init__(self, partner):
        ...
        self.help_text = Label(self.help_frame, text="", justify=LEFT,
                               width=40, bg=background, wrap=300)
        self.help_text.grid()
